...
if($_GET["action"]=='adds') {
  ...
  $query3 = "INSERT INTO tbltransacdetail(transac_code,date,customer_id,pay_met,totalprice,status,add_date)VALUES('".$tat."','".$date."','".$_SESSION['cid']."','".$met."','".$_SESSION['mm']."','Pending','".$del."')";
