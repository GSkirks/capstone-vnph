...
?>
 ...
 <div class="card">
            ...
            <div class="card-header">
             ...
             <center><h2>Virtual Nutritionist PH</h2><p style="font-size: 20px">Brgy. Alangilan Batangas City <br> Batangas </p></center>
         </div>
         ...
         <ul>
            ...
            <?php  }else{
              ?>
              <h5>Your request is on process. Please check your list of added for notification of confirmation.</h5>
           <?php } ?>
