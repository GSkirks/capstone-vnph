...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" type="image/png" href="../admin/images/companylogo.png">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php"><img class="responsive" src="images/companylogo.png" style="width: 50px"><b> Virtual Nutritionist</b>PH</a>
     ...
     if (isset($_SESSION['userid'])) {
      ...
      echo '<a class="nav-link " href="admin.php"><i class="fas fa-user-alt "></i></a>';
     }
      ?>
