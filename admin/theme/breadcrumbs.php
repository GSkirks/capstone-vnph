 ...
 <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Virtual Nutritionist PH</a>
            </li>
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="request.php">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">New Patient/s!</div>
                </div>
