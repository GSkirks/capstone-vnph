...
<div class="container">
  ...
  <form role="form" method="post" action="transactionsave.php?action=adds">
                            ...
                            <h5><i class="fas fa-calendar"></i> Date:<input type="date" name="del" style="width: 206px" required></h5><br>
                            <h2>Summary</h2><br>
                            <div class="row">
                            <div class="col-lg-7" >
                            <h5>Total</h5><br>
                            ...
                            <center><button type="submit" onclick="return confirm('Do you want to submit?')" class="btn btn-lg btn-success">Submit Order</button></center>
